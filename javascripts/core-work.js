define(["jquery", "lodash", "firebase", "hbs", "bootstrap", "q", "get-songs", "authentication", "populate-songs"], 
  function($, lodash,  _firebase, Handlebars, bootstrap, q, getSongs, auth, pop) {
